...
n3 = float(input("Informe a terceira nota do aluno, n3: "))
n4 = float(input("Informe a quarta nota do aluno, n4: "))

# Cálculo da Média e condição do aluno ("aprovado", "reprovado" ou "em exame")
